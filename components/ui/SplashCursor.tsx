...
function SplashCursor({
  ...
  useEffect(() => {
    ...
    function resizeCanvas() {
      let width = scaleByPixelRatio(targetCanvas.clientWidth);
      let height = scaleByPixelRatio(targetCanvas.clientHeight);
    ...
    function correctRadius(radius: number) {
      let aspectRatio = targetCanvas.width / targetCanvas.height;
    ...
    function updatePointerDownData(
      ...
      pointer.texcoordY = 1.0 - posY / targetCanvas.height;
